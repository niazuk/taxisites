...
@section('PageTitle', config('data.privacy.title'))
@section('PageDescription', config('data.privacy.desc'))
@section('PageTags', config('data.privacy.tags'))
@section('Follow','follow')

@section('PageContent')
    <main class="page-content">
        <section class="section-90 section-md-111 text-left">
            <div class="shell"><h1>Privacy Policy</h1>
                <p>Last Updated: January 16, 2019</p>
                <p>{{config('data.meta.sitename')}} ("us", "we", or "our") operates the <a
                            href="{{route('welcome')}}">{{config('data.meta.url')}}</a> website (the
                    "Service").</p>
                ...
                <p>While using our Service, we may ask you to provide us with certain personally identifiable
                    ...
                    be used to contact or identify you ("Personal Data"). Personally identifiable information may
                    include, but is
                    not limited to:</p>
                <ul>
                    <li>Email address</li>
                ...
                <p>{{config('data.meta.sitename')}} uses the collected data for various purposes:</p>
                <ul>
                ...
                <p>Your information, including Personal Data, may be transferred to — and maintained on — computers
                    located outside
                    of your state, province, country or other governmental jurisdiction where the data protection laws
                    may differ
                    than those from your jurisdiction.</p>
                <p>If you are located outside United Kingdom and choose to provide information to us, please note that
                    we transfer
                ...
                <p>Your consent to this Privacy Policy followed by your submission of such information represents your
                    agreement to
                    that transfer.</p>
                <p>{{config('data.meta.sitename')}} will take all steps reasonably necessary to ensure that your data is
                ...
                <p>{{config('data.meta.sitename')}} may disclose your Personal Data in the good faith belief that such
                    action is necessary to:</p>
                <ul>
                    <li>To comply with a legal obligation</li>
                    <li>To protect and defend the rights or property of {{config('data.meta.sitename')}}</li>
                ...
                <p>We may employ third party companies and individuals to facilitate our Service ("Service Providers"),
                    to provide
                    the Service on our behalf, to perform Service-related services or to assist us in analyzing how our
                    Service is
                    used.</p>
                ...
                <ul>
                    <li>
                        ...
                        <p>Google Analytics is a web analytics service offered by Google that tracks and reports website
                            ...
                            shared with
                            other Google services. Google may use the collected data to contextualize and personalize
                            the ads of its
                ...
                <p>We do not knowingly collect personally identifiable information from anyone under the age of 18. If
                    you are a
                    parent or guardian and you are aware that your Children has provided us with Personal Data, please
                    contact us.
                ...
                <p>We may update our Privacy Policy from time to time. You are advised to review this Privacy Policy
                ...
                <ul>
                    <li>By visiting this page on our website: <a
                                href="{{route('contact')}}">{{config('data.meta.url')}}</a></li>
